...
let spriteSheet = "/static/galaga/Images/invaders.gif";
...
let explosion = new Audio("/static/galaga/sounds/explosion.wav");
let invaderKilled = new Audio("/static/galaga/sounds/invaderkilled.wav");
let shoot = new Audio("/static/galaga/sounds/shoot.wav");
let enemySounds = [
  new Audio("/static/galaga/sounds/fastinvader4.wav"),
  new Audio("/static/galaga/sounds/fastinvader2.wav"),
  new Audio("/static/galaga/sounds/fastinvader3.wav"),
  new Audio("/static/galaga/sounds/fastinvader1.wav")
];
...
function saveGalagaScore() {
  fetch('/save_galaga_result', {
    method: 'POST',
    ...
    if (response.ok) {
      ...
      console.error('Failed to save Galaga score.');
    }
  });
}
...
let drawStart = function() {
  ...
  if (flash) {
    ...
    context.fillText(text, canvas.width / 5, canvas.height / 2);
    flash = false;
  }
  else flash = true;
}
